...
python single_event_pe.py --event "GW191216_213338" --gps 1260567236.4 --duration 4 --Mc_prior 3.0 30.0 --ifos "H1" "V1"
...
python single_event_pe.py --event "GW191129_134029" --gps 1259070047.2 --duration 16 --Mc_prior 6.0 11.0 --ifos "H1" "L1"
